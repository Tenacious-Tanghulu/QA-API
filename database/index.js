...
module.exports = {
  ...
  selectAnswersByQuestion_1: questionId => pool.query(`SELECT id, body, date_written AS date, answerer_name, helpful AS helpfulness FROM answers WHERE question_id = ${questionId}`),

  selectAnswersByQuestion_2: questionId => pool.query(`SELECT id AS answer_id, body, date_written AS date, answerer_name, helpful AS helpfulness FROM answers WHERE question_id = ${questionId}`),
